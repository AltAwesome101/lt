...
import unittest # Fixed lecturers Change
...
class TestGetBest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(mark, 90) # Fixed lecturers change (900 => 90)
    ...
    def test_single_student(self):
        ...
        self.assertEqual(student, "999999") # Fixed Lecturers change ( 1 => l)
...
if __name__ == "__main__":  # Fixed Lecturers change
    unittest.main()